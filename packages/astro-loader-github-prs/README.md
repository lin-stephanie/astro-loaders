...
| Option (* required) | Type (default) | Description                                                                                                                                                                                                                                                                                                                                                      |
| ------------------- | -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `identifier`*       | `string \| object` | The identifier for a pull request, which can be one of the following:<br>- A GitHub PR global node ID string, such as `PR_kwDOFL76Q86uDYLC`.<br>- A GitHub PR URL.<br>- An object with fields: `owner`, `repo`, `number`. |
